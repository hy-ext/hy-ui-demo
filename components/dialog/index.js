...
export default class DialogScreen extends Component {
  ...
  getLabel (label, type, index) {
    const color = type === 'confirm' ? variables.hyBrandPrimaryDark : variables.hyGrayDark
    return (
      <View
        style={{
          flex: 1,
      ...
      <ScrollView
        ...
        <View style={styles.container}>
          ...
          <Dialog
            ...
            title='系统提示'
            titleStyle={{ color: variables.hyBrandDanger }}
            bodyText='确认删除该信息？'
            cancelable={true}
          />
          ...
          <Dialog
            ...
            header={
              <View style={{ paddingTop: 30, paddingBottom: 10, alignItems: 'center' }}>
                <Icon type='check-circle' size={50} tintColor={variables.hyBrandSuccess} />
              </View>
            }
            body={
