    ...
    return (
      <ScrollView
        ...
        <BottomModal
          ...
          leftLabelText='失败'
          leftLabelTextStyle={{ color: variables.hyBrandDanger }}
          rightLabelText='成功'
          rightLabelTextStyle={{ color: variables.hyBrandSuccess }}
          rightCallback={() => {
            console.log('confirm')
          }}
        >
        ...
        <BottomModal
          ...
          rightLabel={
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View>
                <Text style={{ color: variables.hyGrayDarker }}>我可以</Text>
                <Text style={{ color: variables.hyGrayDark, fontSize: 12 }}>没问题</Text>
              </View>
              <Text style={{ flex: 1, textAlign: 'right', marginRight: 15, marginTop: 0, fontSize: 25, color: variables.hyGray }}>&times;</Text>
            </View>
          }
          rightCallback={() => {
            console.log('confirm')
