      ...
      <ScrollView style={styles.body}>
        ...
        <Tab
          ...
          renderItem={(item, index, selected) => {
            return (
              <View style={{ paddingVertical: variables.hyVSpacingXL, paddingHorizontal: variables.hyHSpacingXL }}>
                <View
                  style={{
                    padding: 5,
                    borderRadius: 2,
                    backgroundColor: selected ? variables.hyGrayBase : variables.hyFillBody,
                    justifyContent: 'center'
                  }}>
                  <Text
                    style={{
                      fontSize: 12,
                      color: selected ? '#fff' : variables.hyGrayBase
                    }}>
                    {item.label}
                  </Text>
                </View>
