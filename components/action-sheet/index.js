...
const { Button, Actionsheet, Icon } = UI
        ...
        <View style={styles.container}>
          ...
          <Actionsheet
            ...
            header={
              <View
                style={{
                  ...
                  borderBottomColor: variables.hyBorderColor,
                  backgroundColor: '#fff',
                  paddingVertical: 12
                }}>
                <Text
            ...
            renderItem={(item, index) => {
              return (
                <View style={{ flexDirection: 'row', paddingVertical: 13, alignItems: 'center', justifyContent: 'center', borderBottomColor: variables.hyBorderColorDark, borderBottomWidth: StyleSheet.hairlineWidth, backgroundColor: '#fff' }}>
