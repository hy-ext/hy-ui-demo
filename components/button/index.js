      ...
      <ScrollView
        ...
        <View style={styles.panel}>
          <View style={[componentStyles.row, { alignItems: 'center' }]}>
            ...
            <Button
              style={[{ borderColor: variables.hyBrandPrimaryDark }]}
              type='default'
              size='sm'>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <Icon type='plus-circle-o' tintColor={variables.hyBrandPrimaryDark}></Icon>
                <Text style={{ color: variables.hyBrandPrimaryDark, marginLeft: 5 }}>新增</Text>
              </View>
            </Button>
          </View>
        </View>
